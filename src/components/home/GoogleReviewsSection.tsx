        ...
        <div className="grid items-stretch gap-6 lg:grid-cols-2">
          {reviews.map((review, index) => (
            <motion.article
              ...
              className="group relative flex h-full min-h-[430px] flex-col overflow-hidden rounded-[2.25rem] border border-[#e4d6c1]/85 bg-white/72 p-6 shadow-[0_28px_90px_rgba(24,21,18,0.075)] backdrop-blur transition duration-500 hover:-translate-y-1 hover:bg-white hover:shadow-[0_34px_110px_rgba(24,21,18,0.11)] md:p-8"
            >
              ...
              <div className="relative mb-8 flex items-start justify-between gap-5">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[#eadfce] bg-[#f8f0e6] text-sm font-semibold text-[#9b6a35] shadow-inner">
                    {review.initials}
                  </div>
              ...
              <p className="relative flex-1 text-[15px] leading-8 text-neutral-700 md:text-base md:leading-8">
                “{review.text}”
              </p>

              <div className="relative mt-8 flex items-center justify-between border-t border-[#eadfce] pt-5">
